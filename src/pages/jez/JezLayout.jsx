...
// Самостійна обгортка розділу "JEZ — можна слухати" — власний хедер (світлий
// фон і лого громади, як на хедері основного сайту), без Header/Footer
// основного сайту (ізольований розділ, не в головному меню). Хедер за
// макетом: гамбургер-меню зліва, лого громади по центру, пошук справа —
// суто косметика, без функціоналу.
